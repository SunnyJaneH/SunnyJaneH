...
|--------|-----------|------------|
| Deep Learning & Computer Vision | [DeepLearning-ComputerVision-PyTorch](https://github.com/SunnyJaneH/DeepLearning-ComputerVision-PyTorch) | NN from scratch · LeNet-5 · AlexNet · Autoencoder · NPU deployment · SR PSNR 23.98dB |
| Machine Learning | *(coming soon)* | |
| Generative Language Models | *(coming soon)* | |
